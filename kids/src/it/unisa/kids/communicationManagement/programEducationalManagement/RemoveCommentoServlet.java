 ...
 * @author francesco
 */
public class RemoveCommentoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            comment.setId(id);
            activityManager.remove(comment);
        } catch (SQLException ex) {
            Logger.getLogger(RemoveCommentoServlet.class.getName()).log(Level.SEVERE, null, ex);
        } finally {            
            out.close();
        }
    }
