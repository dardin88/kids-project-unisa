 ...
 * Quindi non conviene chiamare una servlet con questo nome, ma indichiamo subito di che responsabilit� si 
 * occupa di gestire.
 * 
 * In pi�, organizziamo le Servlet in maniera migliore: possiamo inserire un package 
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (operation.equals(INSERTTRAINEE)) {
            try {
                ...
                // che viene visualizzata dall'utente ha come nome DBNames.ATT_TRAINEE_NAME. Si pu� fare, ma di 
                ...
                // cos�, ma non appena hai la possibilit�, conviene che lavori prima alle JSP perch� le Servlet sono
                // solo una logica conseguenza
                
                // In generale, comunque, va bene cos�! ;)
