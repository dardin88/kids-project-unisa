...
public final class DBNames {
    ...
    public static final String ATT_REGISTRATIONCHILD_USERRANGE_FULLTIME = "full_time";
    public static final String ATT_REGISTRATIONCHILD_USERRANGE_PARTTIMEAM = "part_time_mattutina";
    public static final String ATT_REGISTRATIONCHILD_USERRANGE_PARTTIMEPM = "part_time_pomeridiana";
    public static final String ATT_REGISTRATIONCHILD_REGISTRATIONPHASE_DRAFT = "bozza";
    public static final String ATT_REGISTRATIONCHILD_REGISTRATIONPHASE_SUBMITTED = "sottomessa";
    public static final String ATT_REGISTRATIONCHILD_REGISTRATIONPHASE_RECEIPT = "ricevuta";
    public static final String ATT_REGISTRATIONCHILD_REGISTRATIONPHASE_DELETED = "eliminata";
    public static final String ATT_REGISTRATIONCHILD_REGISTRATIONPHASE_RECOURSE = "ricorso";
    public static final String ATT_REGISTRATIONCHILD_REGISTRATIONPHASE_ACCEPTED = "accettata";
    public static final String ATT_REGISTRATIONCHILD_REGISTRATIONPHASE_COMPLETED = "completata";
    public static final String ATT_REGISTRATIONCHILD_REGISTRATIONPHASE_VALIDATED = "validata";
    public static final String ATT_REGISTRATIONCHILD_REGISTRATIONPHASE_RENOUNCED = "rinunciata";
